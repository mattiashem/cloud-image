...
--vcpus=2 \
--os-type=linux \
--extra-args='ks=https://raw.githubusercontent.com/mattiashem/cloud-image/master/ks.cfg ksdevice=ens3 ip=192.168.124.90 netmask=255.255.255.0 gateway=192.168.124.1 dns=8.8.8.8' \
