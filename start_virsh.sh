...
sudo virt-install --name=imagecreater.ops.fareoffice.com \
 --ram=2048 \
--vcpus=2 \
--extra-args='ks=https://raw.githubusercontent.com/mattiashem/cloud-image/master/ks.cfg  ip=192.168.122.90 netmask=255.255.255.0 gateway=192.168.122.1 dns=8.8.8.8' \
